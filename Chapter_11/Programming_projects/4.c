...
void analyze_hand(int num_in_suit[NUM_SUITS], int num_in_rank[NUM_RANKS], bool *straight, bool *flush, bool *four, bool *three, int *pairs);
...
int main(void)
{
	...
	for (;;) {
		...
		analyze_hand(num_in_suit, num_in_rank, &straight, &flush, &four, &three, &pairs);
