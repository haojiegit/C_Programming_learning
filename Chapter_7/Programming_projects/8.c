...
int main(void)
{
	int h, m;
	char ampm, ampm2;
	//asking the user to enter a time (expressed in hours and minutes, using the 12-hour clock

	printf("Enter a 12-hour time (hh:mm AM/PM): ");
	scanf("%d:%d %c%c", &h, &m, &ampm, &ampm2);

    // Validate the input hours and minutes
